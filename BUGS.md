...
- `[fixed] 2026-04-18 — Browse/Edit total-count i server-side mode viser kun sidens rækker` — Toolbar viste "10 / 10 endpoints" (kun aktuel side) uden filter, selvom paginerings-baren korrekt viste "Side 1 af 3 (30 total)". I filter-mode vistes "18 / 30 endpoints (filtreret)" korrekt. **Løsning** (build 0031): count i server-side pagination viser nu `${allRows.length} / ${totalEndpoints} endpoints` så page-rows vs total fremgår tydeligt.
