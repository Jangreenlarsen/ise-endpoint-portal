...
def get_backend_settings() -> BackendSettingsResponse:
    ...
    return BackendSettingsResponse(
        ...
        cache_prewarm_skip_fresh_s=getattr(s, "cache_prewarm_skip_fresh_s", 900.0),
        cache_max_entries=getattr(s, "cache_max_entries", 5000),
        cache_max_memory_mb=getattr(s, "cache_max_memory_mb", 300),
        adaptive_pacing_enabled=getattr(s, "adaptive_pacing_enabled", True),
        adaptive_pacing_range_pct=getattr(s, "adaptive_pacing_range_pct", 50.0),
        adaptive_ttl_enabled=getattr(s, "adaptive_ttl_enabled", True),
        adaptive_ttl_max_seconds=getattr(s, "adaptive_ttl_max_seconds", 3600.0),
        adaptive_scan_max_seconds=getattr(s, "adaptive_scan_max_seconds", 14400.0),
        ise_group_cache_ttl_s=getattr(s, "ise_group_cache_ttl_s", 7200.0),
    ...
    overrides.update(
        {
            ...
            "cache_prewarm_skip_fresh_s": new.cache_prewarm_skip_fresh_s,
            "cache_max_entries": new.cache_max_entries,
            "cache_max_memory_mb": new.cache_max_memory_mb,
            "adaptive_pacing_enabled": new.adaptive_pacing_enabled,
            "adaptive_pacing_range_pct": new.adaptive_pacing_range_pct,
            "adaptive_ttl_enabled": new.adaptive_ttl_enabled,
            "adaptive_ttl_max_seconds": new.adaptive_ttl_max_seconds,
            "adaptive_scan_max_seconds": new.adaptive_scan_max_seconds,
            "ise_group_cache_ttl_s": new.ise_group_cache_ttl_s,
...
def get_pxgrid_settings() -> PxGridSettingsResponse:
    ...
    return PxGridSettingsResponse(
        ...
        pxgrid_stomp_recv_timeout_s=getattr(s, "pxgrid_stomp_recv_timeout_s", 7200.0),
    ...
    overrides.update(
        {
            ...
            "pxgrid_stomp_recv_timeout_s": new.pxgrid_stomp_recv_timeout_s,
