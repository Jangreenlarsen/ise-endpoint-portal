...
async def get_dashboard() -> dict:
    ...
    return {
        ...
        "cache": {
            ...
            "effective_ttl_seconds": stats.get("effective_ttl_seconds"),
            "adaptive_ttl_enabled": stats.get("adaptive_ttl_enabled", True),
            "adaptive_ttl_idle_s": stats.get("adaptive_ttl_idle_s"),
