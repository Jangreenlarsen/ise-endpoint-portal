...
Role = Literal["admin", "editor", "editor-psk", "viewer", "registrar", "registrar_templet"]
ROLE_VALUES: tuple[Role, ...] = ("admin", "editor", "editor-psk", "viewer", "registrar", "registrar_templet")
